...
> _Repo: https://github.com/strategykmutt-star/KMUTT-Long-Term-Trend-2568_
...
- **สถานะ:** โค้ดทุกส่วน **เสร็จแล้ว** (frontend + sync pipeline + bootstrap + เอกสาร)
  งานล่าสุดคือ debug การเชื่อมต่อจริง Apps Script ↔ GitHub Actions จนผ่าน
...
- เช็กว่าเว็บยัง live: `https://strategykmutt-star.github.io/KMUTT-Long-Term-Trend-2568/`
...
- ☐ **ยืนยัน flow จริงทำงานครบ** — งานล่าสุดเพิ่ง debug เสร็จ ควรกด Publish ทดสอบ
  อีกครั้งให้มั่นใจว่าไม่มี edge case ตกหล่น
